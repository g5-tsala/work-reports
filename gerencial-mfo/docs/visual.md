...
**Dois gráficos lado a lado compartilham a ordem**, e a ordem sai de um deles (no Resumo e em
Officers, do AUM). Ordenado cada um pelo próprio valor, o mesmo item cai em alturas diferentes e comparar
